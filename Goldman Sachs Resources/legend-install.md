...
Requirements:
- Install an Openshift Container Platform Cluster on Techzone
- oc CLI installed
...
- If the Redirect URIs do not work, try changing the $LEGEND_HOST_DOMAIN variable to the exact output of "echo $LEGEND_HOST_DOMAIN"
...
```shell
open http://$LEGEND_HOST_DOMAIN/studio
```
